          ...
          <div className="lg:col-span-5 w-full flex flex-col gap-5 glass p-6.5 rounded-3xl animate-float">
            <div className="flex justify-between items-center border-b border-slate-800/50 pb-4">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="font-bold text-white text-lg">Urgent SOS Broadcasts</h3>
              </div>
            ...
            <div className="text-center pt-2">
              <Link href="/login" className="text-xs text-slate-400 hover:text-white transition underline underline-offset-4">
          ...
          <div className="max-w-7xl mx-auto px-6 flex flex-col gap-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-slate-950/50 border border-slate-900 p-8 rounded-3xl hover:border-slate-800 transition duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Smart Compatibility Match</h3>
              ...
              <div className="bg-slate-950/50 border border-slate-900 p-8 rounded-3xl hover:border-slate-800 transition duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Real-Time WebSocket Chat</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
              ...
              <div className="bg-slate-950/50 border border-slate-900 p-8 rounded-3xl hover:border-slate-800 transition duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Gamification & Rewards</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
